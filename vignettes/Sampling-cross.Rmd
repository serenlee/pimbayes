...
Data are given by a two by two table. 
...
However, since this test is imperfect, actual model is specified with multinomial distribution with $\eta_{ij}$ instead of $\pi_{ij}$ where \begin{align}
...
Data is a vector that has four entries, where each entry represents the count of each category $(1,1), (1,2), (2,1), (2,2)$ in below contingency table.


According JAGS code is:
