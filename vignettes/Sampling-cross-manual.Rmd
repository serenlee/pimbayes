---
title: "Sampling-sat-manual"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Sampling-sat-manual}
...
## Manually using ISTP algorithm

If required functions and variable names could be provided, function `istp.manual` performs sampling with the ISTP algorithm.
